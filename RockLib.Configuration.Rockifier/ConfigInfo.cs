...
namespace RockLib.Configuration.Editor
{
    public sealed class ConfigInfo
    {
        ...
        internal ConfigInfo(IReadOnlyDictionary<string, Type> sections, IReadOnlyCollection<Type> implementations, IReadOnlyDictionary<MemberInfo, MemberDocumentation> documentation, IReadOnlyDictionary<string, IReadOnlyDictionary<string, string>> settings) => (Sections, Implementations, Documentation, Settings) = (sections, implementations, documentation, settings);
        public IReadOnlyDictionary<string, Type> Sections { get; }
        public IReadOnlyCollection<Type> Implementations { get; }
